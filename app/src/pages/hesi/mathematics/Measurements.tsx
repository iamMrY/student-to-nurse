...
export default function Measurements() {
  const subtopics = [
    ...
    {
      title: 'U.S. Standard System',
      content: [
        'Length (in, ft, yd, mi)',
        'Weight (oz, lb, ton)',
        'Volume (fl oz, cup, pt, qt, gal)',
        'Converting between U.S. units'
      ]
    },
    {
      title: 'Weight and Mass Conversions',
      content: [
        'Metric to U.S. weight conversions',
        'U.S. to metric weight conversions',
        'Common medical weight units',
    ...
    },
    {
      ...
      content: [
        'Metric to U.S. volume conversions',
        'U.S. to metric volume conversions',
        'Medical volume measurements',
        'Fluid calculations'
      ]
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Master measurement systems and unit conversions for the HESI A2 exam.
            </p>
          </div>
