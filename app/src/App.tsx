...
// Quiz Pages
import HesiMathQuiz from './pages/quiz/HesiMathQuiz';
  ...
  return (
    <AuthProvider>
      ...
      <Routes>
        ...
        {/* Quiz Routes */}
        <Route path="/quiz/hesi/math" element={<HesiMathQuiz />} />
        ...
        {/* Learning Math-Sub Routes */}
        <Route path="/hesi/mathematics/learning/basicoperations/basic-of-maths" element={<BasicOperations/>} />
